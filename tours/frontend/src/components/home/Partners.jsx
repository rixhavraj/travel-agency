...
const Partners = () => {
  return (
    <section className="py-16 bg-primary border-y border-white/10 overflow-hidden text-white">
      <div className="container mx-auto px-4 md:px-8 max-w-6xl relative z-10 mb-8">
        <div className="text-center">
          <h3 className="text-sm font-bold text-white/50 uppercase tracking-widest mb-2">Our Trusted Partners</h3>
          <p className="text-white/70 text-sm">We collaborate with the best in the industry to bring you premium experiences.</p>
        </div>
      </div>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="flex w-max animate-partner-marquee hover:pause-marquee items-center py-4">
          {loopedPartners.map((partner, index) => {
            ...
            return (
              <div key={index} className="w-[250px] sm:w-[300px] shrink-0 mx-4 flex justify-center">
                <div className="flex items-center gap-4 opacity-50 hover:opacity-100 hover:scale-105 transition-all duration-300 cursor-pointer grayscale hover:grayscale-0">
                  <div className="w-12 h-12 rounded-xl bg-secondary border border-white/10 flex items-center justify-center text-white shadow-sm">
                    <Icon className="text-2xl" />
                  </div>
                  <div className="flex flex-col">
                    <h4 className="text-xl md:text-2xl font-heading font-black text-white tracking-tight leading-none">
                      {partner.name}
                    </h4>
