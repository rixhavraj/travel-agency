...
const SmartBookingWidget = () => {
  ...
  return (
    <div className="container mx-auto px-4 md:px-8 relative z-30 -mt-24 md:-mt-32">
      <motion.div 
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.8, delay: 0.2 }}
        className="bg-white/10 backdrop-blur-xl border border-white/20 p-6 md:p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.2)]"
      >
