      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted/80 mb-6 text-sm leading-relaxed">
              Pragati Trails Tours & Travel is a trusted tour company specializing in Uttarakhand, Himachal Pradesh, and spiritual tourism. We focus on comfortable travel, quality accommodations, affordable pricing, and excellent customer service to make every trip memorable and hassle-free.
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li className="flex items-start gap-3 text-sm text-muted/80">
                ...
                <span>Greater Noida<br/>Uttar Pradesh, India</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-muted/80">
                <FaPhoneAlt className="text-accent text-lg shrink-0" />
                <a href="tel:+919540640023" className="hover:text-accent transition-colors">+91 95406 40023</a> / <a href="tel:+918287410265" className="hover:text-accent transition-colors">82874 10265</a>
              </li>
              <li className="flex items-center gap-3 text-sm text-muted/80">
                <FaEnvelope className="text-accent text-lg shrink-0" />
                <a href="mailto:info@pragatitrails.com" className="hover:text-accent transition-colors">info@pragatitrails.com</a>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted/60">
          <div className="flex flex-col items-center md:items-start gap-1">
            <p>&copy; {new Date().getFullYear()} Pragati Trails Tours & Travel. All rights reserved.</p>
            <p className="text-accent font-semibold">Designed & Built by <Link to="https://rixhavraj.github.io/portfolio/" target="_blank" rel="noopener noreferrer" className="text-accent font-semibold">Rishav Raj</Link></p>
          </div>
