            ...
            <div className="lg:w-1/2 p-8 md:p-12 flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row gap-8 justify-between mt-auto">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-gray-900 text-lg mb-4">Greater Noida HQ</h4>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <FaPhoneAlt className="text-[#FF5A36] mt-1" />
                      <a href="tel:+919540640023" className="text-gray-500 hover:text-[#FF5A36] transition-colors">(+91) 95406 40023</a>
                    </li>
                    <li className="flex items-start gap-3">
                      <FaMapMarkerAlt className="text-[#FF5A36] mt-1 text-xl shrink-0" />
                      <span className="text-gray-500">Greater Noida, Uttar Pradesh, India</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      <FaPhoneAlt className="text-[#FF5A36] mt-1" />
                      <a href="tel:+918287410265" className="text-gray-500 hover:text-[#FF5A36] transition-colors">(+91) 82874 10265</a>
                    </li>
                    <li className="flex items-start gap-3">
                      <FaMapMarkerAlt className="text-[#FF5A36] mt-1 text-xl shrink-0" />
                      <span className="text-gray-500">Support Center, Greater Noida</span>
                    </li>
                  </ul>
                </div>
