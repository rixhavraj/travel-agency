    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="relative pt-40 pb-24 mb-16 overflow-hidden bg-primary">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-20">
          ...
          >
            About <span className="text-accent">Pragati Trails</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex flex-col lg:flex-row gap-16 mb-24 items-center">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed text-lg">
              Pragati Trails Tours & Travel was founded with a simple yet profound mission: to make the majestic beauty and spiritual heritage of North India accessible to everyone. We specialize in crafting comfortable, hassle-free, and memorable experiences for families, couples, and spiritual seekers.
            </p>
            <p className="text-gray-600 leading-relaxed text-lg">
              Based in Greater Noida, our agency is built on the pillars of quality accommodations, transparent pricing, and unparalleled customer service. Whether you're seeking a thrilling adventure in Rishikesh, a peaceful retreat in Nainital, or a sacred yatra to Kedarnath, we curate every detail so you can focus on the journey.
            </p>
          </motion.div>
